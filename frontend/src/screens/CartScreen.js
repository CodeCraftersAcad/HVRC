...
const CartScreen = ({match, location, history}) => {
    ...
    // location.search is searching the incoming url for the quantity if there is one present
                            ...
                            {cartItems.map(item => (
                                <ListGroup.Item key={item.product}>
                                    <Row>
                                        ...
                                        <Col md={2}>
                                            <Button type='button' variant='outline-danger' onClick={() => removeFromCartAction(item.product)}><i className='fas fa-trash'></i> </Button>
                                        </Col>
                                    </Row>
                                </ListGroup.Item>
                            ))}
